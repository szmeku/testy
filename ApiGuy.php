...
class ApiGuy extends \Codeception\AbstractGuy
{
    ...
    * Conditional Assertion: Test won't be stopped on fail
     ...
     * @return \Codeception\Maybe
     */
    public function login($email, $password, $expectedCode = null, $response = null) {
     ...
     *
     *
     * @see Codeception\Module\ApiHelper::loginAsAdmin()
     * @return \Codeception\Maybe
     */
    public function loginAsAdmin() {
        $this->scenario->addStep(new \Codeception\Step\Action('loginAsAdmin', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
